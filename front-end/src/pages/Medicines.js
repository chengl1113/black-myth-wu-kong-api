...
const Medicines = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Medicines - Black Myth Wukong API</title>
        <meta name="description" content="This is the page for the medicines route for the Black Myth Wukong API" />
        <link rel="canonical" href="https://black-myth-wu-kong-api.vercel.app/medicines" />
      </Helmet>
