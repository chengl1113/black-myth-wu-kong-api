...
const KeyItems = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Key Items - Black Myth Wukong API</title>
                <meta name="description" content="This is the page for the key items route for the Black Myth Wukong API" />
                <link rel="canonical" href="https://black-myth-wu-kong-api.vercel.app/key-items" />
            </Helmet>
